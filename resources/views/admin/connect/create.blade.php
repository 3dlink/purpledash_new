    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-heading center">New Get Connected</div>
                {!! Form::open(['route' => 'admin.connects.store', 'method' => 'POST']) !!}
	            ...
	            <div class="panel-footer">
					...
					{!! Form::submit('Add Get Connected', array('class'=>'btn btn-primary')) !!}
	            </div>
	            {!! Form::close() !!}
            </div>
        </div>
